package com.clj.bleapp.adapter;
...
public class DeviceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (bleDevice != null) {
            ...
            if (isConnected) {
                holder.img_blue.setImageResource(R.drawable.connected);
                holder.txt_name.setTextColor(R.color.colorPrimary);
                holder.txt_mac.setTextColor(R.color.colorPrimary);
                holder.layout_idle.setVisibility(View.GONE);
                holder.layout_connected.setVisibility(View.VISIBLE);
            } else {
                holder.img_blue.setImageResource(R.drawable.ic_bluetooth);
